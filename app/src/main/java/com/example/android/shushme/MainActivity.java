...
public class MainActivity extends AppCompatActivity implements
    ...
    private void refreshPlacesData() {
        Uri contentUri = PlaceContract.PlaceEntry.CONTENT_URI;
        ...
        PendingResult<PlaceBuffer> pendingResult = Places.GeoDataApi.getPlaceById(mGoogleApiClient, guids.toArray(new String[guids.size()]));
